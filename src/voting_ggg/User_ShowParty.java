 ...
 * @author Manahil S
 */
public class User_ShowParty extends javax.swing.JFrame {

    /**
     * Creates new form User_ShowParty
     */
    public User_ShowParty() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Enter Password that");

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 8)); // NOI18N
        jLabel4.setText("is sent to your cellphone");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Customer_ShowParty CSp=new Customer_ShowParty();
            CSp.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(User_ShowParty.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new User_ShowParty().setVisible(true);
            }
        });
    }
